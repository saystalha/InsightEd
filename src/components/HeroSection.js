        ...
        <div className="lg:col-span-7 flex flex-col text-left items-start justify-center animate-fadeUp">
          ...
          <div id="hero-cta" className="flex items-center gap-3.5 flex-wrap justify-start w-full">
            <Link
              href="/login"
              id="hero-cta-start"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-black text-[0.85rem] uppercase tracking-wider btn-primary transition-all active:scale-95 shadow-md"
            >
