  ...
  return (
    <section id="features" className="relative py-16 overflow-hidden features-bg">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 55% 40% at 15% 50%, rgba(59, 130, 246,0.08) 0%, transparent 60%), radial-gradient(ellipse 50% 35% at 85% 60%, rgba(234, 236, 235,0.40) 0%, transparent 60%)",
        }}
      />
          ...
          {FEATURES.map((f) => (
            <article
              ...
              className={`relative flex flex-col p-6 sm:p-7 rounded-[22px] overflow-hidden group transition-all duration-300 border ${
                f.isAccent
                  ? "bg-gradient-to-br from-[#FFFFFF] to-[#FFFFFF] border-[rgba(59, 130, 246,0.35)] shadow-[0_20px_50px_rgba(59, 130, 246,0.1)] -translate-y-1 md:-translate-y-2"
            ...
            >
              ...
              <h3 className="text-base font-black text-snow mb-2 leading-snug tracking-tight">
                {f.title}
              </h3>
              ...
              >
                <span className="text-base font-black text-snow leading-none tracking-tight">
                  {f.metric}
                </span>
              ...
              <div className="border-t pt-3.5 border-black/5 mt-auto">
                <span className="text-xs font-bold transition-colors cursor-pointer text-mist group-hover:text-blue-400">
